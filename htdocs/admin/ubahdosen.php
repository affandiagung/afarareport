...
if(!isset( $_SESSION['login']) || $_SESSION['level'] !== "admin" || $_COOKIE['id'] != 2 )
...
<a href="dosen.php">Kembali</a>
	...
	while($d = mysqli_fetch_array($data)){
		...
		<form method="post" action="ubah_aksidosen.php" enctype="multipart/form-data">
			
					<input type="hidden" name="id" value="<?php echo $d['id']; ?>">
					<input type="hidden" name="gambarlama" value="<?php echo $d['photo_dosen']; ?>">

					<label for="nama_dosen">Nama Dosen :</label>
					<input type="text" name="nama_dosen" id="nama_dosen" value="<?php echo $d['nama_dosen']; ?>"> 	

					<label for="nim_dosen">Nim Dosen :</label>
					<input type="text" name="nim_dosen" id="nim_dosen" value="<?php echo $d['nim_dosen']; ?>"> 	

					<label for="gambar">Gambar :</label><input type="file" name="gambar">
					<label></label><img src="../imgdosen/<?= $d['photo_dosen']; ?>" width="100">
