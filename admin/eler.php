...
<h1 align="center" style="margin-top:100px">Data E-Learning</h1>
<div align="center">
<br>
<div class="hal">
<a href="tambaheler.php" >Tambah Data</a>
</div>
<br>
<!--nav-->
</div>
...
<table border = "1" cellpadding="10" cellspacing="0">
	...
	<tr>
		<td> <?= $i; ?> </td>
		<td> 
			<a class="link" href="ubaheler.php?id=<?= $row["kode_mk"];?>" onclick="return confirm('yakin?')">ubah</a> &#160
			 <a class="link" href="hapuseler.php?id=<?= $row["kode_mk"];?>" onclick="return confirm('yakin?')">hapus</a></td>
